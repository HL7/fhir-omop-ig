...
**Note:** The AllergyIntolerance resource serves as a use case example in the [CodeableConcept](CodeableConceptPattern.html) and [Value as Concept](ValueAsConceptPattern.html) mapping patterns. The principles and patterns are described there in more detail.
