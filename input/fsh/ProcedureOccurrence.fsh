...
* person_id 1..1 integer "Person" "The PERSON_ID of the PERSON for whom the procedure is recorded. This may be a system generated code."
...
* provider_id 0..1 integer "Provider" "The provider associated with the procedure record, e.g. the provider who performed the Procedure."
* visit_occurrence_id 0..1 integer "VisitOccurrence" "The visit during which the procedure occurred."
* visit_detail_id 0..1 integer "Visit Detail" "The VISIT_DETAIL record during which the Procedure occurred. For example, if the Person was in the ICU at the time of the Procedure the VISIT_OCCURRENCE record would reflect the overall hospital stay and the VISIT_DETAIL record would reflect the ICU stay during the hospital visit."
