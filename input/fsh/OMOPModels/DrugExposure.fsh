...
* person_id 1..1 integer "Person" "The PERSON_ID of the PERSON for whom the drug dispensing or administration is recorded. This may be a system generated code."
...
* provider_id 0..1 integer "Provider" "The Provider associated with drug record, e.g. the provider who wrote the prescription or the provider who administered the drug."
* visit_occurrence_id 0..1 integer "Visit Occurrence" "The Visit during which the drug was prescribed, administered or dispensed."
* visit_detail_id 0..1 integer "Visit Detail" "The VISIT_DETAIL record during which the drug exposure occurred. For example, if the person was in the ICU at the time of the drug administration the VISIT_OCCURRENCE record would reflect the overall hospital stay and the VISIT_DETAIL record would reflect the ICU stay during the hospital visit."
