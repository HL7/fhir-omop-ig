...
* provider_id 0..1 integer "Provider" "The provider associated with condition record, e.g. the provider who made the diagnosis or the provider who recorded the symptom."
* visit_occurrence_id 0..1 integer "Visit Occurrence" "The visit during which the condition occurred."
* visit_detail_id 0..1 integer "Visit Detail" "The VISIT_DETAIL record during which the condition occurred. For example, if the person was in the ICU at the time of the diagnosis the VISIT_OCCURRENCE record would reflect the overall hospital stay and the VISIT_DETAIL record would reflect the ICU stay during the hospital visit."
