...
* person_id 1..1 integer "Person" "The PERSON_ID of the PERSON for whom the condition is recorded."
...
// * production_id 0..1 integer "Production" "This is the Production Identifier (UDI-PI) portion of the Unique Device Identification."
...
* provider_id 0..1 integer "Provider" "The Provider associated with device record, e.g. the provider who wrote the prescription or the provider who implanted the device."
* visit_occurrence_id 0..1 integer "Visit Occurence Identifier" "The Visit during which the device was prescribed or given."
* visit_detail_id 0..1 integer "Visit Detail Identifier" "The Visit Detail during which the device was prescribed or given."
