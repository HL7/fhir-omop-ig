...
* location_id 0..1 integer "Location" "The location refers to the physical address of the person. This field should capture the last known location of the person."
* provider_id 0..1 integer "Provider" "The Provider refers to the last known primary care provider (General Practitioner)."
* care_site_id 0..1 integer "Care Site" "The Care Site refers to where the Provider typically provides the primary care."
