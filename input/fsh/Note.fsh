...
* provider_id 0..1 integer "Provider" "The Provider who wrote the note."
* visit_occurrence_id 0..1 integer "Visit Occurence" "The Visit during which the note was written."
* visit_detail_id 0..1 integer "Visit Detail" "The Visit Detail during which the note was written."
* note_source_value 0..1 string "Note Source Value" ""
//* note_event_id 0..1 integer "Note Event"
