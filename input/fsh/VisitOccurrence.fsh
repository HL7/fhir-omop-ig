...
* care_site_id	0..1	integer "Care Site" "This field provides information about the Care Site where the Visit took place."
...
* preceding_visit_occurrence_id	0..1	integer "Preceding Visit Occurrence"	"Use this field to find the visit that occurred for the person prior to the given visit. There could be a few days or a few years in between."
