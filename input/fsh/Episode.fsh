...
* person_id 1..1 integer "Person" "The PERSON_ID of the PERSON for whom the episode is recorded."
...
* episode_parent_id 0..1 integer "Episode Parent" "Use this field to find the Episode that subsumes the given Episode record. This is used in the case that an Episode are nested into each other."
